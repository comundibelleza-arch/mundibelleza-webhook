...
const FAQ_SIEMPRE = [
  ...
  },
  {
    ...
    respuesta: () =>
      "Hola 👋, te saludamos de Mundibelleza. Nos encontramos en Bogotá 🙂, pero " +
      "realizamos despachos a todo el país, con pago contraentrega 🤗, pagas al " +
      "recibir el pedido 🙈.",
  },
  {
  ...
  },
  {
    ...
    respuesta: () =>
      "Tu paquete estará llegando entre 2 y 5 días después del envío 🚛😊. Una " +
      "fecha exacta no manejamos ya que dependemos de los tiempos de la " +
